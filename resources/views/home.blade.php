...
<head>
  ...
  <title>Portofolio - {{ optional($about)->name ?? 'Website' }}</title>
...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      @if(optional($about)->profile_image)
          <img src="{{ asset('storage/' . $about->profile_image) }}" alt="Profile" class="img-fluid rounded-circle" style="width: 120px; height: 120px; object-fit: cover;">
      @else
          <img src="{{ asset('frontend/assets/img/my-profile-img.jpg') }}" alt="Profile" class="img-fluid rounded-circle">
      @endif
    </div>

    <!-- NAMA SIDEBAR -->
    <a href="index.html" class="logo d-flex align-items-center justify-content-center">
      <h1 class="sitename">{{ optional($about)->name ?? 'Alex Smith' }}</h1>
    </a>

    <!-- SOCIAL MEDIA (Hanya muncul jika diisi di Admin) -->
    <div class="social-links text-center">
      @if(optional($about)->twitter_link) <a href="{{ $about->twitter_link }}" target="_blank" class="twitter"><i class="bi bi-twitter-x"></i></a> @endif
      @if(optional($about)->facebook_link) <a href="{{ $about->facebook_link }}" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a> @endif
      @if(optional($about)->instagram_link) <a href="{{ $about->instagram_link }}" target="_blank" class="instagram"><i class="bi bi-instagram"></i></a> @endif
      @if(optional($about)->linkedin_link) <a href="{{ $about->linkedin_link }}" target="_blank" class="linkedin"><i class="bi bi-linkedin"></i></a> @endif
    </div>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      <!-- LOGIKA BANNER DIPERKUAT CSS-NYA -->
      @if(optional($about)->hero_image)
          <img src="{{ asset('storage/' . $about->hero_image) }}" alt="" class="hero-bg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
      @else
          <img src="{{ asset('frontend/assets/img/hero-bg.jpg') }}" alt="" class="hero-bg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
      @endif

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <!-- NAMA BESAR DI TENGAH -->
        <h2>{{ optional($about)->name ?? 'Alex Smith' }}</h2>
        
        <!-- ANIMASI PROFESI -->
        <p>I'm <span class="typed" data-typed-items="{{ optional($about)->hero_titles ?? 'Designer, Developer, Freelancer' }}"></span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About</h2>
        <p>Kenali saya lebih dekat. Berikut adalah sekilas tentang profil, pendidikan, dan apa yang saya lakukan.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
             @if(optional($about)->profile_image)
                <img src="{{ asset('storage/' . $about->profile_image) }}" class="img-fluid rounded" alt="Profile Image" style="width: 100%; object-fit: cover;">
            @else
                <img src="{{ asset('frontend/assets/img/my-profile-img.jpg') }}" class="img-fluid" alt="">
            @endif
          </div>
          <div class="col-lg-8 content">
            <h2>{{ optional($about)->about_title ?? 'UI/UX Designer & Web Developer.' }}</h2>
            <p class="fst-italic py-3">
              Saya adalah seorang profesional yang berdedikasi tinggi terhadap dunia teknologi dan desain.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ optional($about)->birthday ? \Carbon\Carbon::parse($about->birthday)->format('d M Y') : '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>{{ optional($about)->website ?? '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>{{ optional($about)->phone ?? '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>{{ optional($about)->city ?? '-' }}</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>{{ optional($about)->age ?? '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>{{ optional($about)->degree ?? '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>{{ optional($about)->email ?? '-' }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>{{ optional($about)->freelance_status ?? '-' }}</span></li>
                </ul>
              </div>
            </div>
            <p class="py-3">
              {{ optional($about)->about_description ?? 'Deskripsi detail tentang diri Anda belum diisi. Silakan lengkapi melalui panel Admin.' }}
            </p>
          </div>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>Enim nisi quem export duis labore cillum quae magna enim cillum sint quorum nulla quem veniam duis minim tempor labore quem eram duis noster aute amet eram fore quis sint minim.</span>
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
  ...
  <footer id="footer" class="footer position-relative light-background">
    ...
    <div class="container">
      <div class="copyright text-center ">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">{{ optional($about)->name ?? 'Portfolio' }}</strong> <span>All Rights Reserved</span></p>
      </div>
      <div class="credits">
